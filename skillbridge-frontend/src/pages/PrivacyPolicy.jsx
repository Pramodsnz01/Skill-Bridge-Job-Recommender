...
const PrivacyPolicy = () => (
  <div className="max-w-3xl mx-auto px-4 py-12 text-gray-800 dark:text-gray-100">
    ...
    <p className="mb-4">Depending on your jurisdiction, you may have the right to access, correct, or delete your personal information, object to or restrict processing, withdraw consent, or lodge a complaint with a supervisory authority. To exercise your rights, please contact us at <strong>[Insert Contact Email]</strong>.</p>
    ...
    <p className="mb-4">If you have any questions or concerns about this Privacy Policy, please contact us at: <br />
      <strong>Email:</strong> [Insert Contact Email]<br />
      <strong>Address:</strong> [Insert Company/Project Address]
    </p>
