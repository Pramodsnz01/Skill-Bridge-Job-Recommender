...
const Settings = () => {
  ...
  const tabs = [
    { id: 'profile', name: 'Update Profile', icon: '👤', description: 'Personal information and skills' },
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors duration-300 pr-10 ${
