        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/upload-resume" className="text-gray-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Upload Resume
                </Link>
              </li>
              <li>
                <Link to="/career-path" className="text-gray-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Career Path
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/settings" className="text-gray-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Settings
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/privacy-policy" className="text-gray-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Privacy Policy
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-center md:text-left">
              <p className="text-gray-400 text-sm">
                © {currentYear} <span className="text-blue-400 font-semibold">SkillBridge</span>. All rights reserved.
              </p>
            </div>
